...
"</div>"
"<div class=\"cal-section\">"
"<h3>↔️ Leg Tilt - Walk <span style='color:#f39c12;font-size:11px'>⚡ Realtime</span></h3>"
"<div class=\"cal-item\">"
...
"document.getElementById('btnTestFwd').onclick=()=>{fb('btnTestFwd');fetch('/control?x=0&y=80&fwd=1&back=0&test=1');};"  
"document.getElementById('btnTestBack').onclick=()=>{fb('btnTestBack');fetch('/control?x=0&y=-80&fwd=0&back=1&test=1');};"  
...
"document.getElementById('btnCombo1').onclick=()=>{const b=document.getElementById('btnCombo1');b.classList.add('running');fetch('/combo?id=1').finally(()=>b.classList.remove('running'));};"  
"document.getElementById('btnCombo2').onclick=()=>{const b=document.getElementById('btnCombo2');b.classList.add('running');fetch('/combo?id=2').finally(()=>b.classList.remove('running'));};"  
...
"};"  
"}"
"const sliders=['lfn','rfn','lff','rff','lfb','rfb'];"
"sliders.forEach(id=>{"
